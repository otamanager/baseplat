...
public class KindEditor {
	public static String[] FILE_EXT = { "gif", "jpg", "jpeg", "png", "bmp", "swf", "flv", "swf", "flv", "mp3", "wav",
			"wma", "wmv", "mid", "avi", "mpg", "asf", "rm", "rmvb", " doc", "docx", "xls", "xlsx", "ppt", "htm",
	...
	public static Map fileManage(HttpServletRequest req) {
		...
		if (dirName != null) {
			if (!Arrays.<String> asList(new String[] { "image", "flash", "media", "file", "root" }).contains(dirName)) {
				return result;
			}
